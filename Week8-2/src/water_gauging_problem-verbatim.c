...
main() {
    ...
    while(stateCount > 0) {
        ...
        printf("Retrieving [%d,%d] from WAITING\n",s.a,s.b);
        ...
        // if current state s is not the goal, then run successor function
            ...
            printf("[%d,%d] is not the goal - I need to run the successor function...\n",s.a,s.b);
